# Launcher folder — send ALL of these to your girlfriend

She must have **all three files in the same folder**:

- `Play-MazeWars.bat` ← double-click this
- `Play-MazeWars.ps1`
- `config.json`

**Do not** send only the `.bat` file.
